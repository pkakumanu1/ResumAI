  ...
  while (switching) {
    ...
    for (i = 1; i < rows.length - 1; i++) {
      ...
      if (x.innerHTML.toLowerCase() > y.innerHTML.toLowerCase()) {
        // console.log("Inside check Point",x.innerHTML.toLowerCase(),y.innerHTML.toLowerCase())
        shouldSwitch = true;
        break;
      }
      else if (x.innerHTML.toLowerCase() === y.innerHTML.toLowerCase()) {
        if (xx.innerHTML.toLowerCase() > yy.innerHTML.toLowerCase()) {
          // console.log("Inside second checkpoint",xx.innerHTML.toLowerCase(),yy.innerHTML.toLowerCase())
...
function fileInputControlChangeEventHandler(event) {
  ...
  fileReader.onload = function (event) {
    ...
    str3 = String.raw`","features":{"entities":{"limit":250,"model":"26d4c056-6ffd-4638-8f56-568939e6bb9e"},"relations":{"model":"26d4c056-6ffd-4638-8f56-568939e6bb9e"}},"return_analyzed_text":false}`
